function found_slice = registerSliceToVolume(Data3D,Slice2D,Data3Dc,slicedata_b,varargin)
...
found_slice =fit_plane(Data3D,Slice2D,options,Data3Dc,slicedata_b);
